...
sensor1 = sensor.state_add('0', marked=True, initial=True)
sensor2 = sensor.state_add('1', marked = False)

chave1 = chave.state_add('0', marked=True, initial=True)
chave2 = chave.state_add('1', marked=True)
...
espec1 = espec.state_add('0', marked=True, initial=True)
espec2 = espec.state_add('1', marked=False)
